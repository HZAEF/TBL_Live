...
export const FR_KEYS: readonly string[] = [
  ...
  "La somme des quatre pourcentages doit faire exactement 100 %.",
  "lancé",
  ...
  "Note finale",
  "NOTE FINALE sur 20",
  "Note finale sur 20 — iRAT {a} % · tRAT {b} % · Application {c} % · Pairs {d} %",
  ...
  "Pondération de la note finale modifiée",
